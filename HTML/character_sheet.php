...
<body>
        ...
        <h1>SESSION ZERO</h1>
            <nav>
                <ul>
                    ...
                    <li><a href="../HTML/character_sheet.html">Personajes</a></li>
    ...
    <form class="charsheet">
        ...
        <section class="misc">
            <ul>
            <li>
                <label for="classlevel">Class & Level</label><input name="classlevel" placeholder="Bard 1" />
            </li>
            <li>
            ...
            <li>
                <label for="alignment">Alignment</label><input name="alignment" placeholder="" />
            </li>
            <li>
